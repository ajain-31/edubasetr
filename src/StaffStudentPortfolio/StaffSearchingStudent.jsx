...
import './StaffSearchingStudent.css';
import { Link } from 'react-router-dom';
import NavStaff from '../NavStaffFolder/NavStaff';

const StaffSearchingStudent = () => {
        ...
        <div className="results">
          {filterData().map((item) => (
            ...
            >
              ...
              <Link to={`/staffstudentportfolio/${item.id}`} style={{color: "blue"}}>Details</Link>
            </div>
          ))}
        </div>
      </div>
...
export default StaffSearchingStudent;
